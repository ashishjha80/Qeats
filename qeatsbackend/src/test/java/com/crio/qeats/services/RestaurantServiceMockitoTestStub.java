  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    when(restaurantRepositoryServiceMock
            .findAllRestaurantsCloseBy(any(Double.class), any(Double.class),
                eq(LocalTime.of(3, 0)),
                eq(5.0)))
            .thenReturn(Arrays.asList(restaurant1, restaurant2, restaurant3, restaurant4,
            restaurant5));
    ...
    assertEquals("13", allRestaurantsCloseBy.getRestaurants().get(2).getRestaurantId());
    assertEquals("14", allRestaurantsCloseBy.getRestaurants().get(3).getRestaurantId());
    assertEquals("15", allRestaurantsCloseBy.getRestaurants().get(4).getRestaurantId());
